...
/* http://localhost:4000 */
export const baseWebSocketUrl = "just-cinema.herokuapp.com";
export const baseUrl = `https://${ baseWebSocketUrl }`;
...
export const urls = {
  ...
  updateSession: `${ baseUrl }/admin/sessions/updatesession`,
  ...
  deleteSession: `${ baseUrl }/admin/sessions/deletesessions`,
